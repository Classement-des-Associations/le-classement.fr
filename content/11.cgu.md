...
Le site internet [le-classement.fr](https://le-classement.fr) est susceptible de collecter des **données à caractère personnel** vous concernant lorsque vous remplissez les formulaires de collecte (formulaire de contact).
