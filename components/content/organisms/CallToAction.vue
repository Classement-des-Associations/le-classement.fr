...
<template>
  <section class="flex flex-col-reverse gap-10 xl:gap-16 2xl:gap-[6.25rem] pb-[4.5rem] xl:pb-0"
    ...
    <div class="w-full flex-grow flex flex-col justify-center items-center xl:items-start px-4 xl:px-0"
      ...
      <AtomsAppLink class="mt-10 xl:mt-14" v-if="action" :white="isPurple || isBlue" :to="action.to">
        {{ action.text }}
      </AtomsAppLink>
    </div>
