...
if (process.client) {
  async function loadGem() {
    ...
    const { MTLLoader } = await import('three/examples/jsm/loaders/MTLLoader.js' /* webpackChunkName: "trophy" */).then(m => m.default || m)
    const { OBJLoader } = await import('three/examples/jsm/loaders/OBJLoader.js' /* webpackChunkName: "trophy" */).then(m => m.default || m)
    ...
    gltfLoader.load('/assets/home/trophy.gltf', function (gltf) {
