...
<template>
  <li class="flex flex-col space-y-2">
    <div
      class="overflow-hidden rounded-xl flex items-center justify-center h-[140px] relative"
    ...
    <div class="flex justify-between">
      ...
      <div>
        <NuxtLink
          :href="`/assets/design-kit/logos/${imageName}.svg`" aria-label="Télécharger le svg" download
          class="pr-2  text-zinc-400 first-letter:hover:text-zinc-500 hover:underline"
        >
          svg
        </NuxtLink>
        <NuxtLink
          :href="`/assets/design-kit/logos/${imageName}.png`" aria-label="Télécharger le png" download
          class="text-zinc-400 first-letter:hover:text-zinc-500 hover:underline"
        >
          png
        </NuxtLink>
      </div>
