...
<template>
  <NuxtLink class="flex flex-row items-center text-sm leading-4 tracking-wider font-semibold rounded-[0.875rem]  cursor-pointer disabled:cursor-not-allowed disabled:opacity-70
